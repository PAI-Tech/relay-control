    ...
    update(time) {
        ...
        if (this.game.active) {
            if (this.game.downkey) {
                ...
                console.log('Go up');
                this.velocity.y += 0.002;
            } else if (this.game.fkey && this.game.fuel <= 90) {
                // this.game.fuel += 1;
                console.log('fuelup');
            ...
            } else if (this.game.pkey) {
                this.game.pressure += 1;
                this.game.incPressure(5)
                console.log('this.game.pressure');
            }
            this.game.decFuel(0.05);
            this.game.decPressure();

            if (this.game.pressure > 1019) {
                if (this.game.fuel <= 100) {
                    this.game.fuel += 0.5;
                }
            } else if (this.game.pressure < 1008) {
                this.game.incShield(0.5);
